...
const About = () => {
    return (
        <div className='about bg-[#FFF7ED]'>
            ...
            <section className="para w-10/12 mx-auto my-5">
            ...
            <section className="highlight px-10 py-14 bg-[#FFCC8D] w-10/12 m-auto rounded">
                <h1 className='font-bold text-2xl my-2'>Your destination is waiting.
                    Your van is ready.</h1>
                <button className='bg-[#161616] hover:bg-[#232323] text-white font-bold py-2 px-4 rounded my-2'>Explore our vans</button>
            </section>
        </div>
    );
}
